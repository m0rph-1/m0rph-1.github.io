...
TL;DR this script basically just scrapes a given page, and stores words into a list. Not particularly useful, but let's see what happens if we give the test.php a post request as query=URL.
